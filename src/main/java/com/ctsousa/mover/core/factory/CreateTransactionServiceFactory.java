...
@Component
public class CreateTransactionServiceFactory implements TransactionExecutor {
    ...
    public CreateTransactionServiceFactory(IncomeService incomeService, ExpenseService expenseService, InvestimentService investimentService, CorporateCapitalService corporateCapitalService, TransferService transferService) {
    ...
    public TransactionEntity execute(final TypeCategory type, final Transaction transaction) {
        ...
        return mapServicies.get(type).save(transaction);
    }
}
