...
public enum Functionality {
    ...
    REGISTER_CONTRACTS(7, Menu.MY_CLIENTS, "Permite salvar contratos"),
    UPDATE_CONTRACTS(8, Menu.MY_CLIENTS, "Permite atualizar contratos"),
    DELETE_CONTRACTS(9, Menu.MY_CLIENTS, "Permite deletar contratos"),
    TERMINATION_CONTRACTS(10, Menu.MY_CLIENTS, "Permite encerrar contratos"),
    FILTER_CONTRACTS(11, Menu.MY_CLIENTS, "Permite consultar contratos"),

    VIEW_ADDRESS_CLIENTS(12, Menu.MY_CLIENTS, "Permite consultar endereço de clientes"),
    REGISTER_ADDRESS_CLIENTS(13, Menu.MY_CLIENTS, "Permite salvar endereço de clientes"),
    UPDATE_ADDRESS_CLIENTS(14, Menu.MY_CLIENTS, "Permite salvar endereço de clientes"),
    DELETE_ADDRESS_CLIENTS(15, Menu.MY_CLIENTS, "Permite salvar endereço de clientes"),
